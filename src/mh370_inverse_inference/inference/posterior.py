"""Numerically stable posterior normalization for trajectory hypotheses."""
...
class HypothesisScore:
    """Prior probability and log-likelihood for one trajectory hypothesis."""
...
class PosteriorProbability:
    """Normalized posterior probability for one trajectory hypothesis."""
...
def normalize_posteriors(
    ...
    """Normalize prior-weighted log-likelihoods using log-sum-exp."""
    if not scores:
